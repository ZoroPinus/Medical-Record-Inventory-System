	...
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h5 class="modal-title" id="medicalModalLabel">Monthly Accomplishment Report</h5>
								...
								<table class="modal-table" width="100%">
									<thead>
										<tr style="text-align:center;border:1px solid black;padding:10px">
											<th style="text-align:center;border:1px solid black;padding:10px">ACTIVITIES WORK</th>
											<th style="text-align:center;border:1px solid black;padding:10px">TIME AND SCHEDULE</th>
											<th style="text-align:center;border:1px solid black;padding:10px">INTERVENTION/TREATMENT</th>
										</tr>
									</thead>
									<tbody>
										<tr>
											<td><textarea class="form-control" style="height:100px">Online Consultation</textarea></td>
											<td><textarea class="form-control" style="height:100px"></textarea></td>
											<td><textarea class="form-control" style="height:100px"></textarea></td>
										</tr>
										<tr>
											<td><textarea class="form-control" style="height:100px">Duty at the Clinic</textarea></td>
											<td><textarea class="form-control" style="height:100px"></textarea></td>
											<td><textarea class="form-control" style="height:100px"></textarea></td>
										</tr>
										<tr>
											<td><textarea class="form-control" style="height:100px">Kick -Off Activities for the opening class first sem s.y: </textarea></td>
											<td><textarea class="form-control" style="height:100px"></textarea></td>
											<td><textarea class="form-control" style="height:100px"></textarea></td>
										</tr>
										<tr>
								...
								<div class="row">
									...
									<div class="col-md-4">
										<ul>
											...
											<li class="font-italic"><select class="form-control mt-2" id="education" name="education" required>
													<option value="dentist">School Dentist</option>
													<option value="physician">School Doctor</option>
												</select>
											</li>
										</ul>
									</div>
	...
	<script>
		function print() {
			...
			function saveDataURL(dataUrl) {
				...
				$.ajax({
					url: 'model/monthly accomplishment/upload.php',
					type: 'POST',
					data: {
