...
<body>
            ...
            <div class="row pb-10">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card-box pb-10">
                        <div class="h5 pd-20 mb-0">Isolation List</div>
    ...
    <?php include 'modal/Isolation/add_.php'; ?>
    <?php include 'modal/Isolation/edit_.php'; ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function fetchEquipmentList() {
                ...
                $.ajax({
                    url: 'model/Isolation/fetch_.php',
                    type: 'GET',
                    dataType: 'json',
