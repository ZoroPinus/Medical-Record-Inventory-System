...
<body>
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="physical" role="tabpanel" aria-labelledby="physical-tab">
                            <div class="card-box pb-10">
                                <div class="h5 pd-20 mb-0">Onsite Clinical Cases</div>
    ...
    <?php include 'modal/onsite clinic case/add_.php'; ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchCovidReportRecords() {
                ...
                $.ajax({
                    url: 'model/onsite/dentist_accomplishment_report_copy.json',
                    type: 'GET',
                    dataType: 'json',
            ...
            $("#addOnsiteClinicalCasesForm").on("submit", function(event) {
                ...
                $.ajax({
                    url: 'model/onsite/save_data.php', // Path to your PHP script
                    type: 'POST',
            ...
            function extractFormData() {
                ...
                var form = document.getElementById('addOnsiteClinicalCasesForm');
                ...
                for (var i = 1; i < table.rows.length; i++) {
                    ...
                    // Check if input elements are found in the current row
                    var inputs = row.querySelectorAll('input');
                    console.log('Inputs:', inputs);
                    if (inputs.length !== 4) {
                        console.error('Input elements not found or incorrect number of inputs in row ' + i);
                        continue; // Skip this row if input elements are not found or incorrect number of inputs
                    }

                    // Create an object to store the data for each row
                    var rowData = {
                        illness: inputs[0].value,
                        male: inputs[1].value,
